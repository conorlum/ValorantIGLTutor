		...
		return new Promise((resolve) => {
			...
			if (this.isAmpProject || this.isAmpIframe) {
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.primis.tech/live/liveView.php?s=108077&debugInformation=ABT+%2F+GPPServerSide+%2F+3+%2F+default&x=SEKXLEN&y=SEKYLEN&cbuster=1777500703',
					origQString: 's=108077&debugInformation=ABT+%2F+GPPServerSide+%2F+3+%2F+default',
					placementId: 108077,
					x: 600,
					y: 400,
					videoType: 'sticky',
